...
prev_ablation_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.2916584, 0.1742204, 0.058643, 0.058643))
...
prev_disease_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.04725389, 0.07789251, 0.04081146, 0.01525188))
...
**WSSV** Symptoms include [(WOAH, 2023, Ch. 2.2.8, p.3)](https://perma.cc/UR3K-99VY): - Lethargy - Reduced or ceased feeding - Abnormal swimming (slow, on the side, near water surface or round edges of pond) - 'Loosened attachment of the carapace' - Delayed hemolymph clotting
:::
