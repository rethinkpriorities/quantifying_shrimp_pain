...
find_good_sd_binary(mean_val=0.75, tol=1e-6, #sd_val=0.15,
                   fifth_percentile=0.5, ninety_fifth_percentile=1)
find_good_sd_binary(mean_val=0.9, tol=1e-6, #sd_val=0.05,
...
prev_nowater_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.03708807, 0.1728733, 0.1736133, 0.0723155))
...
prev_water_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.173297, 0.03705066, 0.1236821, 0.2478614))
