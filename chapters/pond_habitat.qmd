...
We use observations by [Rivera-Velázquez et al. (2008)](https://doi.org/10.15517/rbt.v56i2.5605) and [Medina-Reyna (2001)](https://perma.cc/3RZ7-PPJH) that shrimp in the wild are found at densities between 0.001 and 4.9 individuals per m^2^ as a reference value, assuming that this density range represents shrimp preferences.
...
row.names(density_summary)<-c(
  "Annoying_dens","Hurtful_dens","Disabling_dens", "Excruciating_dens", "Disabling-Equivalent_High_density")
