...
write.csv(average_hours_lowdo,
          file="../results/full_results/lowdo.csv", row.names=FALSE)
write.csv(average_hours_hitemp,
          file="../results/full_results/hitemp.csv", row.names=FALSE)
write.csv(average_hours_lowtemp,
          file="../results/full_results/lowtemp.csv", row.names=FALSE)
write.csv(average_hours_salin,
          file="../results/full_results/salin.csv", row.names=FALSE)
write.csv(average_hours_ph,
          file="../results/full_results/ph.csv", row.names=FALSE)
write.csv(average_hours_ammon,
          file="../results/full_results/ammon.csv", row.names=FALSE)
write.csv(average_hours_pollute,
          file="../results/full_results/pollute.csv", row.names=FALSE)
