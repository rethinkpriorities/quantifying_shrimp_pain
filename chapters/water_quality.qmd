...
prev_hitemp_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.06183434, 0.04065279, 0.03682119, 0.01854216))
...
prev_lowtemp_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.07280416, 0.0726222, 0.01859695, 0.07053341))
...
prev_salin_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.1516433, 0.1512303, 0.1516433, 0.1137706))
...
prev_ph_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.1239592, 0.07883415, 0.05486407, 0.03679417))
...
prev_ammon_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.1875005, 0.1168816, 0.148216, 0.2121288))
...
prev_pollute_stat <- data.frame(FarmType = c(
  "Extensive", "Semi-Intensive","Intensive","Super-Intensive"),
                               ...
                               sd = c(0.03724687, 0.0550811, 0.01864936, 0.01853204))
